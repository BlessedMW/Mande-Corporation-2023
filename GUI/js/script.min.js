  window.innerWidth<768 && [].slice.call(document.querySelectorAll("[data-bss-disabled-mobile]")).forEach((function(t)  {
  ...
  t.removeAttribute("data-aos")
    ...
    [].slice.call(document.querySelectorAll("[data-bss-hover-animate]")).forEach((function(t) {
      t.addEventListener("mouseenter",(function(t) {
      t.target.classList.add("animated",t.target.dataset.bssHoverAnimate)}
      )),t.addEventListener("mouseleave",(function(t) {
      t.target.classList.remove("animated",t.target.dataset.bssHoverAnimate)}
    ))}
  ))}
                                                   
  ),!1),function(t){"use strict";
  function e(e,n) {
  ...
  var o =  {
    ...
    ,freeInput : !0,addOnBlur : !0,maxTags : void 0,maxChars : void 0,confirmKeys : [13,44],delimiter : ",",delimiterRegex : null,cancelConfirmKeysOnEmpty : !0,onTagExists : function(t,e) {
    e.hide().fadeIn()}
  ...
  e.prototype =  {
    constructor : e,add : function(e,n,i) {
      var r = this;
      if(!(r.options.maxTags && r.itemsArray.length>=r.options.maxTags) && (!1 === e || e)) {
        ...
        if(!e.toString().match(/^\s*$/)) {
          if(r.isSelect && !r.multiple && r.itemsArray.length>0 && r.remove(r.itemsArray[0]),"string "== typeof e && "INPUT" === this.$element[0].tagName) {
            var o = r.options.delimiterRegex ? r.options.delimiterRegex : r.options.delimiter,s = e.split(o);
            if(s.length>1) {
              for(var l = 0;
              l<s.length;
              l++)this.add(s[l],!0);
            return void(n || r.pushVal())}
            }var u = r.options.itemValue(e),c = r.options.itemText(e),p = r.options.tagClass(e),m = r.options.itemTitle(e),d = t.grep(r.itemsArray,(function(t) {
              return r.options.itemValue(t) === u
            }
            ))[0];
            if(!d || r.options.allowDuplicates) {
              if(!(r.items().toString().length+e.length+1>r.options.maxInputLength)) {
                var h = t.Event("beforeItemAdd", {
                  item : e,cancel : !1,options : i
                }
                );
                if(r.$element.trigger(h),!h.cancel) {
                  r.itemsArray.push(e);
                  var f = t('<span class = "tag '+a(p)+(null !== m ? '" title = "'+m : "")+'">'+a(c)+'<span data - role = "remove"></span></span>');
                  if(f.data("item",e),r.findInputWrapper().before(f),f.after(" "),r.isSelect && !t('option[value = "'+encodeURIComponent(u)+'"]',r.$element)[0]) {
                    var v = t("<option selected>"+a(c)+"</option>");
        ...
        ,removeAll : function() {
          var e = this;
          for(t(".tag",e.$container).remove(),t("option",e.$element).remove();
        ...
        ,refresh : function() {
          ...
          t(".tag",e.$container).each((function() {
            var n = t(this),i = n.data("item"),r = e.options.itemValue(i),o = e.options.itemText(i),s = e.options.tagClass(i);
            (n.attr("class",null),n.addClass("tag "+a(s)),n.contents().filter((function() {
              return 3== this.nodeType
            }
            ))[0].nodeValue = a(o),e.isSelect) && t("option",e.$element).filter((function() {
        ...
        ,build : function(e) {
          var a = this;
          if(a.options = t.extend( {
          }
          ,o,e),a.objectItems && (a.options.freeInput = !1),n(a.options,"itemValue"),n(a.options,"itemText"),i(a.options,"tagClass"),a.options.typeahead) {
            var s = a.options.typeahead ||  {
            }
            ;
            i(s,"source"),a.$input.typeahead(t.extend( {
            }
            ,s, {
              source : function(e,n) {
                function i(t) {
            ...
            if(a.options.typeaheadjs) {
              ...
              ,c = a.options.typeaheadjs;
              t.isArray(c) ? (l = c[0],u = c[1]) : u=c,a.$input.typeahead(l,u).on("typeahead : selected",t.proxy((function(t,e) {
            ...
            0 === t(".typeahead,.twitter - typeahead",a.$container).length && (a.add(a.$input.val()),a.$input.val(""))}
              ...
              if(a.$element.attr("disabled"))a.$input.attr("disabled","disabled");
                ...
                switch(e.which) {
                  ...
                  break;
                  case 37 : var l = i.prev();
                  0 === n.val().length && l[0] && (l.before(i),n.focus());
                  break;
                  case 39 : var u = i.next();
              ...
              Math.ceil(c / 5),n.attr("size",Math.max(this.inputSize,n.val().length))}
                ...
                if(a.$element.attr("disabled"))a.$input.attr("disabled","disabled");
                  ...
                  a.options.freeInput && (function(e,n) {
                    ...
                    return t.each(n,(function(t,n) {
                      ...
                      if(e.which === n.which) {
                        var a = !n.hasOwnProperty("altKey") || e.altKey === n.altKey,r = !n.hasOwnProperty("shiftKey") || e.shiftKey === n.shiftKey,o = !n.hasOwnProperty("ctrlKey") || e.ctrlKey === n.ctrlKey;
                        if(a && r && o)return i = !0,!1
                      }
                    })),i
                  }
                  (e,a.options.confirmKeys) || r) && (0 !== i.length && (a.add(r ? i.substr(0,a.options.maxChars) : i),n.val("")),!1 === a.options.cancelConfirmKeysOnEmpty && e.preventDefault());
                  var o = n.val().length;
                ...
                ),a)),a.options.itemValue === o.itemValue && ("INPUT" === a.$element[0].tagName ? a.add(a.$element.val()) : t("option",a.$element).each((function() {
              ...
              ,findInputWrapper : function() {
                for(var e = this.$input[0],n = this.$container[0];
                e && e.parentNode !== n;
                )e = e.parentNode;
              return t(e)}
                ...
                return this.each((function() {
                  ...
                  if(o)if(n || i) {
                    if(void 0 !== o[n]) {
                      if(3 === o[n].length && void 0 !== a)var s = o[n](i,null,a);
                      else s = o[n](i);
                    void 0 !== s && r.push(s)}
                  }else r.push(o);
                else o = new e(this,n),t(this).data("tagsinput",o),r.push(o),"SELECT" === this.tagName && t("option",t(this)).attr("selected","selected"),t(this).val(t(this).val())}
            ...
            (window.jQuery),$(document).ready((function() {
              $('input[data - role = "tagsinput"]').each((function(t,e) {
                var n = e.dataset.class;
                n && $(e).tagsinput( {
                  tagClass : function() {
                    return"label "+n
                  }
                ...
                var e;
                e = () = > {
                  const e = t.querySelector(".dismiss"),n = t.querySelector(".sidebar"),i = t.querySelector(".overlay"),a = t.querySelector(".open - menu");
                  n && (e.addEventListener("click",(() = > {
                  n.classList.remove("active"),i.classList.remove("active")}
                  )),i.addEventListener("click",(() = > {
                  n.classList.remove("active"),i.classList.remove("active")}
                  )),a.addEventListener("click",(t = > {
                  t.preventDefault(),n.classList.add("active"),i.classList.add("active")}
                  )),t.querySelector(".nav - link").addEventListener("click",(() = > {
                  n.classList.remove("active"),i.classList.remove("active")}
                )))}
